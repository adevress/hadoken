...
enum class life_status { home = 0, work = 1, bed = 3, beer = 4 };
...
BOOST_AUTO_TEST_CASE(semaphore_test) {
    ...
    semaphore_state_machine.add_transition(life_status::home, life_status::work,
                                           [&]() -> bool { return bool(drive_to.consume()); });

    semaphore_state_machine.add_transition(life_status::work, life_status::home,
                                           [&]() -> bool { return bool(drive_back.consume()); });

    semaphore_state_machine.add_transition(life_status::home, life_status::bed,
                                           [&]() -> bool { return bool(need_sleep.consume()); });

    semaphore_state_machine.add_transition(life_status::bed, life_status::home,
                                           [&]() -> bool { return bool(morning.consume()); });

    semaphore_state_machine.add_transition(life_status::home, life_status::beer, [&]() -> bool { return bool(fun.consume()); });

    semaphore_state_machine.add_transition(life_status::work, life_status::beer, [&]() -> bool { return bool(fun.consume()); });


    semaphore_state_machine.add_transition(life_status::beer, life_status::bed,
                                           [&]() -> bool { return bool(need_sleep.consume()); });
