...
BOOST_AUTO_TEST_CASE(uri_parsing) {
    ...
    BOOST_CHECK_THROW({ false_uri.get_scheme(); }, std::invalid_argument);

    BOOST_CHECK_THROW({ false_uri.get_userinfo(); }, std::invalid_argument);

    BOOST_CHECK_THROW({ false_uri.get_host(); }, std::invalid_argument);

    BOOST_CHECK_THROW({ false_uri.get_path(); }, std::invalid_argument);

    BOOST_CHECK_THROW({ false_uri.get_query(); }, std::invalid_argument);


    BOOST_CHECK_THROW({ false_uri.get_fragment(); }, std::invalid_argument);
...
BOOST_AUTO_TEST_CASE(test_encode) {
    ...
    BOOST_CHECK_EQUAL(
        res, "%E7%A7%81%E3%81%AF%E3%82%AC%E3%83%A9%E3%82%B9%E3%82%92%E9%A3%9F%E3%81%B9%E3%82%89%E3%82%8C%E3%81%BE%E3%81%99%E3%"
             "80%82%E3%81%9D%E3%82%8C%E3%81%AF%E7%A7%81%E3%82%92%E5%82%B7%E3%81%A4%E3%81%91%E3%81%BE%E3%81%9B%E3%82%93");
